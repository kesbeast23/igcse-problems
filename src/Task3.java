...
public class Task3 {
    public static void main(String[] args) throws Exception {
        ...
        if (list[0]!=null) { //check if discount should be given
            Product temp = phones[selectedphone-1];
 
            temp.setPrice(temp.getPrice()-(temp.getPrice()*0.1));
            System.out.println(temp.getPrice());
            cartlist.add(temp); // add item to cart
